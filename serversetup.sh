...
EOF
    ...
    a2enmod ssl
    cd /etc/apache2/sites-available/
    a2enssite webmail-ssl.conf

    cat <<-EOF > /var/www/webmail/data/_data_/_default_/configs/application.ini
[webmail]
; Text displayed as page title
title = "EXT Infrastructure"

; Text displayed on startup
loading_description = "EXT Infrastructure"
favicon_url = ""
...
csrf_protection = On
custom_server_signature = "Infrastructure"
x_frame_options_header = ""
openpgp = Off

; Login and password for web admin panel
admin_login = "admin"
admin_password = "f609d8c1a6f69c1325e9d4f8e7ab4d8e"
...
[version]
current = "1.12.0"
saved = "Thu, 23 Aug 2018 18:52:42 +0000"
EOF
